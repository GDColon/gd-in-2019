...
class $modify(CreatorLayer) {
    ...
    bool init() {
		...
		*/
		...
		buttonList->addChild(makeLargeButton("paths", 131.285f, 236.444f, menu_selector(CreatorLayer::onPaths)));
		...
		buttonList->addChild(makeLargeButton("paths", 234.416f, 236.444f, menu_selector(CreatorLayer::onPaths)));
		...
		buttonList->addChild(makeLargeButton("paths", 337.547f, 236.444f, menu_selector(CreatorLayer::onPaths)));
		buttonList->addChild(makeLargeButton("search", 371.924f, 236.444f, menu_selector(CreatorLayer::onOnlineLevels)));
		buttonList->addChild(makeLargeButton("map", 79.719f, 206.222f, menu_selector(CreatorLayer::onAdventureMap)));
		buttonList->addChild(makeLargeButton("weekly", 114.096f, 206.222f, menu_selector(CreatorLayer::onWeeklyLevel)));
		buttonList->addChild(makeLargeButton("lists", 148.473f, 206.222f, menu_selector(CreatorLayer::onTopLists)));
		buttonList->addChild(makeLargeButton("map", 182.851f, 206.222f, menu_selector(CreatorLayer::onAdventureMap)));
		buttonList->addChild(makeLargeButton("weekly", 217.228f, 206.222f, menu_selector(CreatorLayer::onWeeklyLevel)));
		buttonList->addChild(makeLargeButton("lists", 251.605f, 206.222f, menu_selector(CreatorLayer::onTopLists)));
		buttonList->addChild(makeLargeButton("map", 285.982f, 206.222f, menu_selector(CreatorLayer::onAdventureMap)));
		buttonList->addChild(makeLargeButton("weekly", 320.359f, 206.222f, menu_selector(CreatorLayer::onWeeklyLevel)));
		buttonList->addChild(makeLargeButton("lists", 354.736f, 206.222f, menu_selector(CreatorLayer::onTopLists)));
		...
		buttonList->addChild(makeLargeButton("paths", 131.285f, 115.556f, menu_selector(CreatorLayer::onPaths)));
		...
		buttonList->addChild(makeLargeButton("paths", 234.416f, 115.556f, menu_selector(CreatorLayer::onPaths)));
		...
		buttonList->addChild(makeLargeButton("paths", 337.547f, 115.556f, menu_selector(CreatorLayer::onPaths)));
		buttonList->addChild(makeLargeButton("search", 371.924f, 115.556f, menu_selector(CreatorLayer::onOnlineLevels)));
		buttonList->addChild(makeLargeButton("map", 79.719f, 85.333f, menu_selector(CreatorLayer::onAdventureMap)));
		buttonList->addChild(makeLargeButton("weekly", 114.096f, 85.333f, menu_selector(CreatorLayer::onWeeklyLevel)));
		buttonList->addChild(makeLargeButton("lists", 148.473f, 85.333f, menu_selector(CreatorLayer::onTopLists)));
		buttonList->addChild(makeLargeButton("featured", 96.908f, 55.111f, menu_selector(CreatorLayer::onFeaturedLevels)));
		buttonList->addChild(makeLargeButton("paths", 131.285f, 55.111f, menu_selector(CreatorLayer::onPaths)));
		buttonList->addChild(makeLargeButton("search", 165.662f, 55.111f, menu_selector(CreatorLayer::onOnlineLevels)));
		buttonList->addChild(makeLargeButton("map", 182.851f, 85.333f, menu_selector(CreatorLayer::onAdventureMap)));
		buttonList->addChild(makeLargeButton("weekly", 217.228f, 85.333f, menu_selector(CreatorLayer::onWeeklyLevel)));
		buttonList->addChild(makeLargeButton("lists", 251.605f, 85.333f, menu_selector(CreatorLayer::onTopLists)));
		buttonList->addChild(makeLargeButton("featured", 200.039f, 55.111f, menu_selector(CreatorLayer::onFeaturedLevels)));
		buttonList->addChild(makeLargeButton("paths", 234.416f, 55.111f, menu_selector(CreatorLayer::onPaths)));
		buttonList->addChild(makeLargeButton("search", 268.793f, 55.111f, menu_selector(CreatorLayer::onOnlineLevels)));
		buttonList->addChild(makeLargeButton("map", 285.982f, 85.333f, menu_selector(CreatorLayer::onAdventureMap)));
		buttonList->addChild(makeLargeButton("weekly", 320.359f, 85.333f, menu_selector(CreatorLayer::onWeeklyLevel)));
		buttonList->addChild(makeLargeButton("lists", 354.736f, 85.333f, menu_selector(CreatorLayer::onTopLists)));
		buttonList->addChild(makeLargeButton("event", 389.113f, 85.333f, menu_selector(CreatorLayer::onEventLevel)));
		buttonList->addChild(makeLargeButton("featured", 303.170f, 55.111f, menu_selector(CreatorLayer::onFeaturedLevels)));
		buttonList->addChild(makeLargeButton("paths", 337.547f, 55.111f, menu_selector(CreatorLayer::onPaths)));
